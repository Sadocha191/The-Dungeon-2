...
local guildPlaceLocationsModule = serverModuleFolder:FindFirstChild("GuildPlaceLocations")
assert(guildPlaceLocationsModule and guildPlaceLocationsModule:IsA("ModuleScript"), "[GuildPlace] GuildPlaceLocations ModuleScript is required")
local GuildPlaceLocations = require(guildPlaceLocationsModule)
...
local GUILD_LOCATION_DEFINITIONS = GuildPlaceLocations.GetDefinitions()
...
local function getLocationStatus(definition)
	return GuildPlaceLocations.GetStatus(definition)
end

local function buildGuildLocationState()
	return GuildPlaceLocations.BuildState()
end
...
local function openGuildLocation(player, locationId)
	local definition = GuildPlaceLocations.GetDefinition(locationId)
