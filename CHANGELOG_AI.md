...
Ten plik jest lekkim indeksem. Pełne wpisy znajdują się w plikach miesięcznych, aby Codex nie musiał czytać kilku tysięcy linii przy każdym zadaniu.

## Zasada aktualizacji

- Po zmianie dopisz pełny wpis do `docs/changelog/CHANGELOG_AI_YYYY-MM.md`.
- W tym pliku aktualizuj jedynie listę ostatnich zmian, jeżeli jest to przydatne.
- Nie czytaj całych archiwów bez związku z bieżącym zadaniem.
...
> Pełne szczegóły, pliki, testy, ryzyka i rollback znajdują się w odpowiednim miesięcznym changelogu.
