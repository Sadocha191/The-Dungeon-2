...
-- CO: HUD (monety + HP/EXP) + auto-hide gdy istnieje ScreenGui z atrybutem Modal=true i Enabled=true
...
-- AUTO-HIDE: jesli jakikolwiek ScreenGui ma Modal=true i Enabled=true, chowamy HUD
