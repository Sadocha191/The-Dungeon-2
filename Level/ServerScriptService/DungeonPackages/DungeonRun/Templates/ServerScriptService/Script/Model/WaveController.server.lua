...
local LEVEL_ENEMY_CONFIG = LevelConfig.Enemies
local LEVEL_RUN_CONFIG = LevelConfig.Run
local RUN_TIME_LIMIT = LEVEL_RUN_CONFIG.TimeLimitSeconds
...
local MINIBOSS_INTERVAL_SECONDS = LEVEL_RUN_CONFIG.MinibossIntervalSeconds
local ELITE_FIRST_SPAWN_SECONDS = LEVEL_RUN_CONFIG.EliteFirstSpawnSeconds
local ELITE_INTERVAL_SECONDS = LEVEL_RUN_CONFIG.EliteIntervalSeconds
local BOSS_REINFORCEMENT_INTERVAL = LEVEL_RUN_CONFIG.BossReinforcementIntervalSeconds
local SWARM_EVENT_TIMES = LEVEL_RUN_CONFIG.SwarmEventTimes
local SWARM_DURATION = LEVEL_RUN_CONFIG.SwarmDurationSeconds
...
local function buildMiniBossOrder(): {string}
	...
	local preferred = LEVEL_ENEMY_CONFIG.MinibossOrder or {}
	local result = {}
	local used = {}
...
spawnBossNearPortal = function()
	...
	local bossName = LEVEL_ENEMY_CONFIG.Boss.Name
