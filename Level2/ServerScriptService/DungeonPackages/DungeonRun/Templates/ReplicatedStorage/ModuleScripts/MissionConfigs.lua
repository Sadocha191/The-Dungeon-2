...
add({ Id="D_COINS_COLLECTOR", Type="Daily", Group="Economy", Title="Run Gold Collector", Description="Earn 1,500 Run Gold in dungeons.", Reward={Silver=0,WeaponPoints=60}, Goal={Type="Counter",Key="COINS_EARNED",Target=1500}, Repeatable=false })
...
add({ Id="W_ECONOMY", Type="Weekly", Group="Economy", Title="Run Gold Economy", Description="Earn 12,000 Run Gold in dungeons.", Reward={Silver=0,WeaponPoints=280}, Goal={Type="Counter",Key="COINS_EARNED",Target=12000}, Repeatable=false })
